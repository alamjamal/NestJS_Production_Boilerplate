...
export class UserDto {
    ...
    @ApiProperty({ example: true, description: 'Verification status', required: false })
    @IsBoolean()
    @IsOptional()
    isVerified?: boolean;
    ...
    @ApiProperty({ example: '2023-10-01T12:00:00Z', description: 'Created At', required: false })
    @IsOptional()
    createdAt?: Date;
    @ApiProperty({ example: '2023-10-01T12:00:00Z', description: 'Updated At', required: false })
    @IsOptional()
    updatedAt?: Date;
}
